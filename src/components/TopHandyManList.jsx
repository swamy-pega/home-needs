...
<div className='w-50% grid grid-cols-auto gap-4 pt-5 gap-y-6 px-3 sm:px-0'>
{HandymanList.slice(0,10).map( (items,index)=>
(
    <div className='border grid grid-cols-auto border-blue-200 rounded-xl p-4 overflow-hidden cursor-pointer hover:translate-y-[-10px] transition-all duration-500' key={index}>
